...
class LinePlotTestCase(unittest.TestCase):
    ...
    def test_plot_title(self):
        ...
        self.assertEqual(
            actual, expected, "Expected line plot title to be 'Rise in Sea Level'"
        )
    ...
    def test_plot_labels(self):
        ...
        self.assertEqual(
            actual, expected, "Expected line plot ylabel to be 'Sea Level (inches)'"
        )
    ...
    def test_plot_lines(self):
        ...
        np.testing.assert_almost_equal(
            actual, expected, 7, "Expected different line for first line of best fit."
        )
        ...
        np.testing.assert_almost_equal(
            actual, expected, 7, "Expected different line for second line of best fit."
        )
